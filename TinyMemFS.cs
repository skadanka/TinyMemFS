...
/// **************** THE COMPLETE PROGRAM WITH ALL CLASS IN SAME FILE FOR Review ****************** ///
namespace TinyMemFS
{
    ...
    // Serializable to allow to store objects state on disk // 
    [Serializable()]
    public class FileObject : ISerializable
    {
        ...
        // ** Two priority Queues to allow bigger requests to push to the head of Queue to avoid Bottle Necks ** //
